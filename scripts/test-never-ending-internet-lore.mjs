...
assert.match(css, /grid-template-columns:\s*max-content max-content max-content/, "side columns sit against the selected poster");
assert.match(css, /\.chrono-arrow-shape\s*\{[^}]*fill:\s*currentColor/, "watch-order arrows are filled curves");
