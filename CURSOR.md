...
| `marvel-chronology-view.js` | Marvel default: Watch Before / Selected / Watch Next focus layout with circular cast. Full chronological list is `?view=chronology`, a scrollable poster timeline |
